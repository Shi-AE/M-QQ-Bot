...
from nonebot.adapters.onebot.v11 import Bot, MessageSegment, Message, GroupMessageEvent, Event
...
w = on_keyword({'原神', 'GenShin', 'GenShin_Impact'}, priority=5)
lt = 0
...
call = on_command("叫", aliases={"叫我"}, priority=5)


@call.handle()
async def _(arg: Message = CommandArg()):
    await call.finish(f"{arg}!", at_sender=True)
